...
#define LS                     0.00074 /* Stator inductance, H
...
#define NOMINAL_CURRENT         6893
#define MOTOR_MAX_SPEED_RPM     2980 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  6.0 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -6893 /*!< Demagnetization current */
...
#define HALL_PHASE_SHIFT        53 /*!< Define here in degrees
